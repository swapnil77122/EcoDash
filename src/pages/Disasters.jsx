...
const DisasterMap = () => {
  ...
  return (
    <div>
      ...
      {/* Filters */}
      {/* Page Title */}
<h2 className="text-lg font-bold text-black mb-4">🌍 Global Disaster Map</h2>
      ...
      {/* 🔴 Legend (Updated for Matching Marker) */}
      <div className="text-sm text-red-600 font-semibold mt-4 flex items-center">
        <span
          className="inline-block mr-2 rounded-full border border-red-700"
          style={{
            width: '12px',
            height: '12px',
